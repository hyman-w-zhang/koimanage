...
urlpatterns = [
    ...
    url(r'export_users$', views.export_users, name='export_users'),
    ...
    url(r'export_pay_journals$', views.export_pay_journals, name='export_pay_journals'),
    ...
    url(r'export_consume_journals$', views.export_consume_journals, name='export_consume_journals'),
