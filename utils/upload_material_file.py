...
def save_file(file_path, file, file_name=None):
    ...
    file_name = file_name or str(ObjectId())
...
def save_material_file(file, file_name=None):
    return 'zips/' + save_file(material_dir, file, file_name=file_name)
...
def parse_video_info(video_file_name):
    ...
    video_file = os.path.join(base_dir, video_file_name)
    ...
    return int(width), int(height), int(duration), int(file_size)


def parse_thumb_info(thumb_file_name):
    thumb_file = os.path.join(base_dir, thumb_file_name)
...
def parse_material_info(material_file_name):
    material_file = os.path.join(base_dir, material_file_name)
